...
{
    public class CreatePositionHandler : IRequestHandler<CreatePositionQuery, Result<PositionDtoo>>
    {
        ...
        public async Task<Result<PositionDtoo>> Handle(CreatePositionQuery request, CancellationToken cancellationToken)
        {
            ...
            return Result.Ok(_mapper.Map<PositionDtoo>(newPosition));
        }
    }
}