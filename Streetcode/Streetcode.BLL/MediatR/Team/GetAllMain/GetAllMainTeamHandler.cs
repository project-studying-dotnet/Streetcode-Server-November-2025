...
{
    public class GetAllMainTeamHandler : IRequestHandler<GetAllMainTeamQuery, Result<IEnumerable<TeamMemberDtoo>>>
    {
        ...
        public async Task<Result<IEnumerable<TeamMemberDtoo>>> Handle(GetAllMainTeamQuery request, CancellationToken cancellationToken)
        {
