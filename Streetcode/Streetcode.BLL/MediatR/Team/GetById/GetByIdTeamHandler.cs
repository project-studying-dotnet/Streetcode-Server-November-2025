...
{
    public class GetByIdTeamHandler : IRequestHandler<GetByIdTeamQuery, Result<TeamMemberDtoo>>
    {
        ...
        public async Task<Result<TeamMemberDtoo>> Handle(GetByIdTeamQuery request, CancellationToken cancellationToken)
        {
            ...
            return Result.Ok(_mapper.Map<TeamMemberDtoo>(team));
        }
    }
}