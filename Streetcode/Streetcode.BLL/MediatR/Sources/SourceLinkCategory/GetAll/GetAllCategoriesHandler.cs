...
{
    public class GetAllCategoriesHandler : IRequestHandler<GetAllCategoriesQuery, Result<IEnumerable<SourceLinkCategoryDtoo>>>
    {
        ...
        public async Task<Result<IEnumerable<SourceLinkCategoryDtoo>>> Handle(GetAllCategoriesQuery request, CancellationToken cancellationtoken)
        {
            ...
            var dtos = _mapper.Map<IEnumerable<SourceLinkCategoryDtoo>>(allCategories);
