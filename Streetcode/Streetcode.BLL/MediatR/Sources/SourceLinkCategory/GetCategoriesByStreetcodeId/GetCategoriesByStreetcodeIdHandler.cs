...
public class GetCategoriesByStreetcodeIdHandler : IRequestHandler<GetCategoriesByStreetcodeIdQuery, Result<IEnumerable<SourceLinkCategoryDtoo>>>
{
    ...
    public async Task<Result<IEnumerable<SourceLinkCategoryDtoo>>> Handle(GetCategoriesByStreetcodeIdQuery request, CancellationToken cancellationToken)
    {
        ...
        var mappedSrcCategories = _mapper.Map<IEnumerable<SourceLinkCategoryDtoo>>(srcCategories);
