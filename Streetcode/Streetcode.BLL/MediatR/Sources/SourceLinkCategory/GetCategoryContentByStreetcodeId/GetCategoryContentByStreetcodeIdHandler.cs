...
{
    public class GetCategoryContentByStreetcodeIdHandler : IRequestHandler<GetCategoryContentByStreetcodeIdQuery, Result<StreetcodeCategoryContentDtoo>>
    {
        ...
        public async Task<Result<StreetcodeCategoryContentDtoo>> Handle(GetCategoryContentByStreetcodeIdQuery request, CancellationToken cancellationToken)
        {
            ...
            return Result.Ok(_mapper.Map<StreetcodeCategoryContentDtoo>(streetcodeContent));
        }
    }
}
