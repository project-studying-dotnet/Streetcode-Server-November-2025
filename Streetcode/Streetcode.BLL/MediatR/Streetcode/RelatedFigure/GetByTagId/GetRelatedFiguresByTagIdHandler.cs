...
{
  internal class GetRelatedFiguresByTagIdHandler : IRequestHandler<GetRelatedFiguresByTagIdQuery, Result<IEnumerable<RelatedFigureDtoo>>>
    {
        ...
        public async Task<Result<IEnumerable<RelatedFigureDtoo>>> Handle(GetRelatedFiguresByTagIdQuery request, CancellationToken cancellationToken)
        {
            ...
            return Result.Ok(_mapper.Map<IEnumerable<RelatedFigureDtoo>>(streetcodes));
        }
    }
}
