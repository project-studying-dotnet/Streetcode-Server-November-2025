...
public class GetRelatedFiguresByStreetcodeIdHandler : IRequestHandler<GetRelatedFigureByStreetcodeIdQuery, Result<IEnumerable<RelatedFigureDtoo>>>
{
    ...
    public async Task<Result<IEnumerable<RelatedFigureDtoo>>> Handle(GetRelatedFigureByStreetcodeIdQuery request, CancellationToken cancellationToken)
    {
        ...
        return Result.Ok(_mapper.Map<IEnumerable<RelatedFigureDtoo>>(relatedFigures));
    }
