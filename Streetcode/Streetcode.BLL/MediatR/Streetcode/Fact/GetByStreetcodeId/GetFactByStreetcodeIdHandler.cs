...
public class GetFactByStreetcodeIdHandler : IRequestHandler<GetFactByStreetcodeIdQuery, Result<IEnumerable<FactDtoo>>>
{
    ...
    public async Task<Result<IEnumerable<FactDtoo>>> Handle(GetFactByStreetcodeIdQuery request, CancellationToken cancellationToken)
    {
        ...
        return Result.Ok(_mapper.Map<IEnumerable<FactDtoo>>(fact));
    }
}