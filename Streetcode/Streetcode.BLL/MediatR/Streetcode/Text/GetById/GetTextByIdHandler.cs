...
public class GetTextByIdHandler : IRequestHandler<GetTextByIdQuery, Result<TextDtoo>>
{
    ...
    public async Task<Result<TextDtoo>> Handle(GetTextByIdQuery request, CancellationToken cancellationToken)
    {
        ...
        return Result.Ok(_mapper.Map<TextDtoo>(text));
    }
}