...
namespace Streetcode.BLL.MediatR.Streetcode.Streetcode.GetAllMainPage
{
    public class GetAllStreetcodesMainPageHandler : IRequestHandler<GetAllStreetcodesMainPageQuery,
        Result<IEnumerable<StreetcodeMainPageDtoo>>>
    {
        ...
        public async Task<Result<IEnumerable<StreetcodeMainPageDtoo>>> Handle(GetAllStreetcodesMainPageQuery request, CancellationToken cancellationToken)
        {
            ...
            if (streetcodes != null)
            {
                return Result.Ok(_mapper.Map<IEnumerable<StreetcodeMainPageDtoo>>(streetcodes));
            }
