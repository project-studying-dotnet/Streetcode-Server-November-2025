...
public class GetSubtitleByIdHandler : IRequestHandler<GetSubtitleByIdQuery, Result<SubtitleDtoo>>
{
    ...
    public async Task<Result<SubtitleDtoo>> Handle(GetSubtitleByIdQuery request, CancellationToken cancellationToken)
    {
        ...
        return Result.Ok(_mapper.Map<SubtitleDtoo>(subtitle));
    }
}