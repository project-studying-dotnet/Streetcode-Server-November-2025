...
public class GetTagByStreetcodeIdHandler : IRequestHandler<GetTagByStreetcodeIdQuery, Result<IEnumerable<StreetcodeTagDtoo>>>
{
    ...
    public async Task<Result<IEnumerable<StreetcodeTagDtoo>>> Handle(GetTagByStreetcodeIdQuery request, CancellationToken cancellationToken)
    {
        /*
        ...
        */
        ...
        return Result.Ok(_mapper.Map<IEnumerable<StreetcodeTagDtoo>>(tagIndexed.OrderBy(ti => ti.Index)));
    }
}
