...
{
  public class CreateTagHandler : IRequestHandler<CreateTagQuery, Result<TagDtoo>>
    {
        ...
        public async Task<Result<TagDtoo>> Handle(CreateTagQuery request, CancellationToken cancellationToken)
        {
            ...
            return Result.Ok(_mapper.Map<TagDtoo>(newTag));
        }
    }
}
