...
{
  public class GetStreetcodeArtByStreetcodeIdHandler : IRequestHandler<GetStreetcodeArtByStreetcodeIdQuery, Result<IEnumerable<StreetcodeArtDtoo>>>
    {
        ...
        public async Task<Result<IEnumerable<StreetcodeArtDtoo>>> Handle(GetStreetcodeArtByStreetcodeIdQuery request, CancellationToken cancellationToken)
        {
            /*
            ...
            */
            ...
            var artsDto = _mapper.Map<IEnumerable<StreetcodeArtDtoo>>(art);
