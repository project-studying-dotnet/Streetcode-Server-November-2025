...
public class CreateAudioHandler : IRequestHandler<CreateAudioCommand, Result<AudioDtoo>>
{
    ...
    public async Task<Result<AudioDtoo>> Handle(CreateAudioCommand request, CancellationToken cancellationToken)
    {
        ...
        var createdAudio = _mapper.Map<AudioDtoo>(audio);
