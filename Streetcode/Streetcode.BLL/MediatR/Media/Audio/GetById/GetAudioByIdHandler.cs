...
public class GetAudioByIdHandler : IRequestHandler<GetAudioByIdQuery, Result<AudioDtoo>>
{
    ...
    public async Task<Result<AudioDtoo>> Handle(GetAudioByIdQuery request, CancellationToken cancellationToken)
    {
        ...
        var audioDto = _mapper.Map<AudioDtoo>(audio);
