...
public class GetVideoByIdHandler : IRequestHandler<GetVideoByIdQuery, Result<VideoDtoo>>
{
    ...
    public async Task<Result<VideoDtoo>> Handle(GetVideoByIdQuery request, CancellationToken cancellationToken)
    {
        ...
        return Result.Ok(_mapper.Map<VideoDtoo>(video));
    }
}