...
{
    public class GetNewsByUrlHandler : IRequestHandler<GetNewsByUrlQuery, Result<NewsDtoo>>
    {
        ...
        public async Task<Result<NewsDtoo>> Handle(GetNewsByUrlQuery request, CancellationToken cancellationToken)
        {
