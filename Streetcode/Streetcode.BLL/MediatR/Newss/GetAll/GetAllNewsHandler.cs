...
{
    public class GetAllNewsHandler : IRequestHandler<GetAllNewsQuery, Result<IEnumerable<NewsDtoo>>>
    {
        ...
        public async Task<Result<IEnumerable<NewsDtoo>>> Handle(GetAllNewsQuery request, CancellationToken cancellationToken)
        {
            ...
            var newsDTOs = _mapper.Map<IEnumerable<NewsDtoo>>(news);
