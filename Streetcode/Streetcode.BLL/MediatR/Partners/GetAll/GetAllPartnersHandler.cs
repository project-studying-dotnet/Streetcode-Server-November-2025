...
public class GetAllPartnersHandler : IRequestHandler<GetAllPartnersQuery, Result<IEnumerable<PartnerDtoo>>>
{
    ...
    public async Task<Result<IEnumerable<PartnerDtoo>>> Handle(GetAllPartnersQuery request, CancellationToken cancellationToken)
    {
        ...
        return Result.Ok(_mapper.Map<IEnumerable<PartnerDtoo>>(partners));
    }
}
