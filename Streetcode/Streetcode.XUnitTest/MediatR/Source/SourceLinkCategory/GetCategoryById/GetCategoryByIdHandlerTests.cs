...
namespace Streetcode.XUnitTest.MediatR.Sources.SourceLink.GetCategoryById
{
    ...
    public class GetCategoryByIdHandlerTests
    {
        ...
        public async Task Handle_ShouldReturnOk_WhenCategoryExists()
        {
            ...
            var dto = new SourceLinkCategoryDtoo { Id = id, Image = new ImageDtoo { BlobName = "blob" } };
            ...
            this.mockMapper.Setup(m => m.Map<SourceLinkCategoryDtoo>(category))
                .Returns(dto);
        ...
        {
            // Arrange
            string errorMsg = $"Cannot find any srcCategory by the corresponding id: {id}";
