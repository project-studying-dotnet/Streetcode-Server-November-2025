...
namespace Streetcode.XUnitTest.MediatR.Sources.SourceLinkCategory.GetAll
{
    ...
    public class GetAllCategoriesHandlerTests
    {
        ...
        public async Task Handle_ShouldReturnOk_WhenCategoriesExist()
        {
            ...
            var dtos = new List<SourceLinkCategoryDtoo>
            {
                new SourceLinkCategoryDtoo { Id = 1, Image = new ImageDtoo { BlobName = "blob1" } },
            };
            ...
            this.mockMapper.Setup(m => m.Map<IEnumerable<SourceLinkCategoryDtoo>>(categories))
                .Returns(dtos);
